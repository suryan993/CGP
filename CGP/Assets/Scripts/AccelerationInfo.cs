...
public class AccelerationInfo : MonoBehaviour
{
    // public values
    ...
    void Awake()
    {
        ...
        slider = GameObject.FindGameObjectWithTag("AccelerationSlider").GetComponent<Slider>();

        // set the range values to their default
    ...
    public void DisplayCurrentAcceleration(float currentA, float minA, float maxA)
    {
        slider.value = (currentA - minA) / maxA;
    }
